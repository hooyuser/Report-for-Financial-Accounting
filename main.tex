...
%% general metadata:
\newcommand{\myauthor}{Introduction to Finance-Term project}  %% also used for PDF metadata (hyperref)
\newcommand{\mytitle}{A Financial Analysis for JD.com, Inc.}  %% also used for PDF metadata (hyperref)
\newcommand{\mysubject}{SUBJECT}  %% also used for PDF metadata (hyperref)
\newcommand{\mykeywords}{KEYWORDS}  %% also used for PDF metadata (hyperref)

%% this information is used only for generating the title page:
\newcommand{\myworktitle}{for the year ended  December 31, 2016}  %% official type of work like ``Master theses''
...
\newcommand{\myinstitute}{{\large INSTRUCTOR}:\\\;LI Xiaoxi} %% affiliation
\newcommand{\myinstitutehead}{{\large PARTNERS}:\\
YANG Rongze\\
 CHEN Huyi\\
FU Huaiyu} %% head of institute
...
\textbf{\LARGE Responsibility Statement}
	...
	\begin{center}
		\begin{tabular}{ |l|l|l| }
			...
			%\rowcolor[gray]{.95}
			\textbf{Group
				members}	& \textbf{Sections
				responsible for } &\textbf{Editorial work} \\
			\hline		 	            	
			YANG Rongze	& 1,2,3,4,16 & First draft \\
			CHEN Huyi& 5,6,7,8,9 &\LaTeX\ layout design, First draft \\
			FU Huaiyu& 10,11,12,13,14,15&First draft\\
			\hline
		\end{tabular}
	\end{center}
...
\input{article}   %% remove this line to get rid of the example chapter
